...
public class GongFaCompanyBalanceSheetGeneral {
    ...
    private String equityWithSecurityNatureVirtualCurrency;
    @JsonProperty("資本公積")
    ...
    private String equityUnderCommonControl;
    @JsonProperty("合併前非屬共同控制股權")
    private String equityBeforeCombinationNotUnderCommonControl;
    @JsonProperty("非控制權益")
    ...
    public String getEquityWithSecurityNatureVirtualCurrency() {
        return equityWithSecurityNatureVirtualCurrency;
    }

    public void setEquityWithSecurityNatureVirtualCurrency(String equityWithSecurityNatureVirtualCurrency) {
        this.equityWithSecurityNatureVirtualCurrency = equityWithSecurityNatureVirtualCurrency;
    }
    ...
    public String getEquityUnderCommonControl() {
        return equityUnderCommonControl;
    }

    public void setEquityUnderCommonControl(String equityUnderCommonControl) {
        this.equityUnderCommonControl = equityUnderCommonControl;
    }

    public String getEquityBeforeCombinationNotUnderCommonControl() {
        return equityBeforeCombinationNotUnderCommonControl;
    }

    public void setEquityBeforeCombinationNotUnderCommonControl(String equityBeforeCombinationNotUnderCommonControl) {
        this.equityBeforeCombinationNotUnderCommonControl = equityBeforeCombinationNotUnderCommonControl;
    }
    ...
    public String toString() {
        return "GongFaCompanyBalanceSheetGeneral{" +
                "issueDate='" + issueDate + '\'' +
                ", year='" + year + '\'' +
                ", quarter='" + quarter + '\'' +
                ...
                ", equityWithSecurityNatureVirtualCurrency='" + equityWithSecurityNatureVirtualCurrency + '\'' +
                ", capitalReserve='" + capitalReserve + '\'' +
                ", retainedEarnings='" + retainedEarnings + '\'' +
                ", otherEquity='" + otherEquity + '\'' +
                ", treasuryStock='" + treasuryStock + '\'' +
                ", totalEquityAttributableToOwnersOfParent='" + totalEquityAttributableToOwnersOfParent + '\'' +
                ", equityUnderCommonControl='" + equityUnderCommonControl + '\'' +
                ", equityBeforeCombinationNotUnderCommonControl='" + equityBeforeCombinationNotUnderCommonControl + '\'' +
                ", nonControllingInterest='" + nonControllingInterest + '\'' +
                ", totalEquity='" + totalEquity + '\'' +
                ", sharesToBeCancelled='" + sharesToBeCancelled + '\'' +
                ", advanceReceivedForSharesEquitySectionEquivalentIssuedShares='" + advanceReceivedForSharesEquitySectionEquivalentIssuedShares + '\'' +
                ", treasurySharesHeldByParentAndSubsidiaries='" + treasurySharesHeldByParentAndSubsidiaries + '\'' +
                ", referenceNetValuePerShare='" + referenceNetValuePerShare + '\'' +
                '}';
    }
}
